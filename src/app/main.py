...
st.set_page_config(
    page_title="MSFT OLS handbook PDF Chatbot",
    page_icon="🚀",
    layout="wide",
...
def main() -> None:
    ...
    """
    st.subheader("🧠 MSFT OLS handbook PDF Chatbot", divider="gray", anchor=False)
    ...
    use_sample = col1.toggle(
        "Use sample PDF (MSFT OLS handbook V25)", 
        key="sample_checkbox"
    )
    ...
    if use_sample:
        # Use the sample PDF
        sample_path = "data/pdfs/sample/New_OLS_hand_book.pdf"
